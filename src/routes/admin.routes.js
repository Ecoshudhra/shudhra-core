...
const { validateAdminRegister,
    validateAdminLogin,
    validateAdminLoginWithOTP } = require('../middlewares/admin.middleware');
...
module.exports = function (io) {
    ...
    router.post('/auth/verify-otp', validateAdminLoginWithOTP, controllers.adminValidateWithOTP(io));
